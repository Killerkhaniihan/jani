...
os.system('clear')
print('\n\033[1;37m Loading killer Tools...')
try:
...
try:
    prox= httpCaht = requests.get('https://raw.githubusercontent.com/Killerkhaniihan/jani/main/approval.txt').text
...
def aprv():
    ...
    if k in r:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+1(930)201-0054?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
